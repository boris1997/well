...
`
const FeedbackContentItem = styled.form`
display: flex;
flex: 1;
flex-direction: column;
...
`
const FeedbackLabel = styled.label`   display: flex;
font-size: 1.2rem;
flex-direction: column;
@media screen and (max-width: 1280px) { 
      font-size: 1rem;
...
const Contact = () => {
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('gmail', 'template_cu4qmqd', e.target, 'user_VURn9rVG2vKdUuqGLnF7Z')
            .then((result) => {
            ...
            <Container>
                ...
                <FeedbackContent>
                    <FeedbackContentInner>
                        ...
                        <FeedbackContentItem onSubmit={sendEmail}>

                            <FeedbackGroup>
                                <FeedbackLabel htmlFor="sername">Фамилия</FeedbackLabel>
                                <FeedbackInput type="sername" name="sername" required className="feedback__form-control" id="sername" placeholder=""></FeedbackInput>
                                {/* <FeedbackInvalid>
                    ...
                    Имя не должно содержать цифр
                            ...
                            <FeedbackGroup>
                                <FeedbackLabel htmlFor="phone"> номер телефона</FeedbackLabel>
                                <FeedbackInput type="phone" name="phone" required="" className="feedback__form-control" id="phone" placeholder=""></FeedbackInput>
                                {/* <FeedbackInvalid>
